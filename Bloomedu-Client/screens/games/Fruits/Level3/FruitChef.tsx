...
const RECIPES = [
  ...
  { id: 2, target: 'banana', count: 2, question: "Put 2 bananas in the bowl!" },
  { id: 3, target: 'apple', count: 2, question: "Put 2 apples in the bowl!" },
];

const MAX_ROUNDS = 3;

const FruitChefLevel3 = ({ navigation }: any) => {
...
export default FruitChefLevel3;